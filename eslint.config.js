...
export default [
  {
    ignores: [
      ...
      /**
       * Design mockups exported from a third-party prototyping tool. They are
       * committed as reference material, never imported by any app, and never
       * hand-edited — linting a vendor bundle reports 151 problems nobody is
       * allowed to fix.
       */
      'Design-refrences/**',
      'mobile/.expo/**',
