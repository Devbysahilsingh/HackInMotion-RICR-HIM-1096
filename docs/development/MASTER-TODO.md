...
- [ ] [P0](A) Kaggle account + kaggle.json at C:\Users\Sahil\.kaggle + accept Paddy Doctor competition rules ✔ `kaggle competitions files paddy-disease-classification` lists
...
- [ ] [P0](C) «keys» `scripts/ml/download-datasets.py` → raw datasets + checksums ✔ manifest counts match published sizes
